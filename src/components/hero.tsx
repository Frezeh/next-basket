  ...
  return (
    <section className="flex flex-col items-center lg:items-start xl:items-center justify-center py-6 sm:py-20 sm:px-10">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-[15px]">
        <div className="relative inset-0 w-[331px] h-[300px] sm:w-[451px] lg:w-[331px] xl:w-[451px] sm:h-[616px] object-cover flex-shrink-0">
          <Image
        ...
        <div className="space-y-[15px]">
          <div className="relative inset-0 w-[331px] h-[300px] sm:w-[451px] xl:w-[678px] lg:w-[580px] object-cover flex-shrink-0">
            <Image
          ...
          <div className="flex flex-col lg:flex-row items-center gap-4">
            <div className="relative inset-0 w-[331px] h-[300px] sm:w-[451px] lg:w-[280px] xl:w-[331px] object-cover flex-shrink-0">
              <Image
