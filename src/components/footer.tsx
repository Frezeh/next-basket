...
export default function Footer() {
  return (
    <footer className="flex flex-col">
      <div className="px-11 lg:px-20 2xl:px-[195px] bg-[#FAFAFA]">
        <div className="flex flex-col sm:flex-row justify-between gap-5 w-full py-10 ">
          <Link href="/">
      ...
      <div className="px-10 py-10 sm:py-0 lg:px-20 2xl:px-[195px]">
        <div className="grid sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 gap-[30px] w-full py-[50px]">
          ...
          <div className="space-y-5">
            ...
            <form className="relative" onSubmit={(e) => e.preventDefault()}>
              <input
                className="w-[321px] h-[58px] py-[15px] rounded-[5px] pl-5 pr-36 border border-[#E6E6E6] bg-[#F9F9F9] ring-offset-background file:border-0 file:bg-transparent placeholder:text-secondTextColor focus-visible:outline-primaryColor focus-visible:ring-1 focus-visible:ring-ring"
                placeholder="Your Email"
                type="email"
                required
              />
              <Button
                className="absolute top-0 right-[0px] sm:left-[175px] w-[117px] h-[58px]"
                type="submit"
              >
                Subscribe
              </Button>
            </form>
            <span className="text-xs text-secondTextColor">
