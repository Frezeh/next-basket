...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/*** Banner ***/}
      <div className="hidden bg-[#23856D] py-4 px-9 lg:flex items-center justify-between">
        <div className="flex items-center gap-5">
          <div className="flex items-center gap-[5px]">
            ...
            <p className="text-sm font-bold text-white">
              <Link href="tel+2255550118">(225) 555-0118</Link>
            </p>
          </div>
          <div className="flex items-center gap-[5px]">
            <svg
      ...
      <div className={`bg-white ${open && "h-[700px] animate-slide-down"}`}>
        <div className="px-7 sm:px-[38px] py-[17px] flex items-center justify-between">
          <div className="flex items-center gap-10">
            ...
            <div className="hidden lg:flex gap-[15px]">
              ...
              <Link
                href="/"
                className="flex items-center gap-[9px] text-secondTextColor transition-all hover:text-textColor text-sm font-bold"
              >
                Shop
          ...
          <div className="hidden lg:flex items-center justify-between gap-[15px]">
            <div className="flex items-center gap-[5px]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="12"
              ...
              <Link href="/" className="text-sm font-bold text-primaryColor">
                Login / Register
              </Link>
            </div>
        ...
        {open && (
          <div className="animate-slide-down bg-white w-full h-[290px] rounded-b-[24px] lg:hidden flex flex-col justify-center items-center gap-6 absolute top-[30%] mt-8">
            ...
            <Link
              href="/"
              className="flex items-center gap-[9px] text-secondTextColor transition-all hover:text-textColor text-3xl"
            >
              Shop
              <span className="pt-[2px]">
                <svg
            ...
            <div className="flex items-center gap-[5px]">
              ...
              <Link href="/" className="text-3xl text-primaryColor">
                Login / Register
              </Link>
            </div>
