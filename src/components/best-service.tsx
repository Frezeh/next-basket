...
export default function BestService() {
  return (
    <section className="flex flex-col justify-center items-center py-20">
      ...
      <div className="pt-20 grid sm:grid-cols-3 gap-[30px]">
        <div className="px-10 py-[35px] flex flex-col items-center gap-5 max-w-[315px]">
          <svg
          ...
          <p className="text-2xl font-bold">Easy Wins</p>
          <p className="text-center text-sm text-secondTextColor">
        ...
        <div className="px-10 py-[35px] flex flex-col items-center gap-5 max-w-[315px]">
          ...
          <p className="text-2xl font-bold">Concrete</p>
          <p className="text-center text-sm text-secondTextColor">
        ...
        <div className="px-10 py-[35px] flex flex-col items-center gap-5 max-w-[315px]">
          ...
          <p className="text-2xl font-bold">Hack Growth</p>
          <p className="text-center text-sm text-secondTextColor">
